...
public class TidalDataListener extends AnalysisEventListener<TidalData>  {
    private final List<TidalData> dataList = new ArrayList<>();

    @Override
    public void invoke(TidalData data, AnalysisContext context) {
    ...
    public List<TidalData> getDataList() {
        return dataList;
    }
}
